...
Processed order PDF buttons now open through the print-server helper endpoint at `https://printguard-scan.desenio.cz/pdf-open` instead of direct UNC/file links.
