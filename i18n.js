(() => {
  const translations = {
    cs: {
      ...
      'processed.status.reprint-pending': 'Reprint čeká',
      ...
      'processed.reprint.status.waiting': 'Čeká',
      'processed.reprint.status.in-production': 'Ve výrobě',
      'processed.reprint.status.done': 'Hotovo',
    ...
    en: {
      ...
      'processed.status.reprint-pending': 'Reprint pending',
      ...
      'processed.reprint.status.waiting': 'Waiting',
      'processed.reprint.status.in-production': 'In production',
      'processed.reprint.status.done': 'Done',
