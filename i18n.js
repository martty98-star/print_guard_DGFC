(() => {
  const translations = {
    cs: {
      ...
      'settings.cost.ink': 'Náklad inkoustu (SEK/L)',
      'settings.cost.media': 'Náklad média (SEK/m²)',
      'settings.cost.hint': 'Po vyplnění se zobrazí finanční metriky SEK/m² v přehledu Colorado.',
    ...
    en: {
      ...
      'settings.cost.ink': 'Ink cost (SEK/L)',
      'settings.cost.media': 'Media cost (SEK/m²)',
      'settings.cost.hint': 'Once filled in, financial metrics in SEK/m² will appear in the Colorado overview.',
