(() => {
  const translations = {
    cs: {
      ...
      'scan.title': 'Scan objednávek',
      'scan.status.local-ready': 'Lokální scan fronta připravena',
      ...
      'scan.status.missing-api': 'Chybí PrintGuardScanCaptureApi.',
      'scan.operator': 'Operátor',
      'scan.operator.placeholder': 'Jméno',
      'scan.station': 'Stanice',
      'scan.pin': 'PIN pro odeslání',
      'scan.barcode.placeholder': 'Naskenuj čárový kód objednávky…',
      'scan.save': 'Uložit scan',
      'scan.kpi.pending': 'Pending scans',
      'scan.kpi.pending.desc': 'čekají v browser queue',
      'scan.kpi.last': 'Poslední barcode',
      'scan.kpi.last.desc': 'poslední scan v této obrazovce',
      'scan.kpi.local': 'Lokální fronta',
      'scan.kpi.local.desc': 'uloženo v tomto prohlížeči',
      'scan.kpi.commit': 'Poslední commit',
      ...
      'scan.queue.empty': 'Lokální fronta je prázdná.',
      'scan.delete': 'Smazat',
      'scan.summary.read': 'Přečteno',
      'scan.summary.committed': 'Commitnuto',
      'scan.summary.matched': 'Spárováno',
      'scan.summary.unmatched': 'Nespárováno',
      'scan.summary.skipped': 'Duplicity / přeskočeno',
      'scan.summary.errors': 'Chyby',

      'processed.title': 'Zpracované tiskové objednávky',
      'processed.status.default': 'Data ze serveru',
      'processed.status.loading': 'Načítám…',
      'processed.status.searching': 'Hledám…',
      'processed.status.rows': 'objednávek v pipeline',
      'processed.status.search-results': 'výsledků hledání',
      'processed.status.load-failed': 'Načtení selhalo',
      'processed.status.pin-required': 'Vyžadován PIN operátora',
      'processed.status.all': 'Všechny objednávky',
      'processed.status.needs-attention': 'K řešení',
      'processed.status.unprocessed': 'Nezpracované',
      'processed.status.processed': 'Zpracované',
      'processed.status.reprint-pending': 'Čeká na dotisk',
      'processed.status.no-api-match': 'Bez API páru',
      'processed.status.has-reprint': 'Má reprint',
      ...
      'processed.quick.reprint-backlog': 'Reprint backlog',
      'processed.quick.no-api-match': 'Bez API páru',
      'processed.quick.printed-out': 'Dotisknuto',
      'processed.summary.unprocessed': 'Nezpracované',
      'processed.summary.reprint-backlog': 'Reprinty',
      'processed.summary.needs-attention': 'K řešení',
      'processed.summary.no-api-match': 'Bez API páru',
      'processed.summary.debug': 'Technické metriky',
      'processed.summary.legacy-technical': 'Legacy / technické',
      'processed.summary.operational': 'Provozní souhrn',
      'processed.summary.scope': 'Filtr',
      ...
      'processed.search.placeholder': 'Hledat',
      ...
      'processed.filters.advanced': 'Pokročilé filtry',
      'processed.filters.period': 'Období',
      'processed.filters.month': 'Měsíc importu',
      'processed.filters.from': 'Od',
      'processed.filters.to': 'Do',
      'processed.filters.reprint-history': 'Reprint historie',
      'processed.reprint.all': 'Všechny objednávky',
      'processed.reprint.has': 'Má reprint',
      'processed.reprint.pending': 'Čeká na dotisk',
      ...
      'processed.badge.reprint-pending': 'REPRINT V ŘEŠENÍ',
      'processed.badge.reprint-requested': 'POŽADAVEK ZADÁN',
      'processed.badge.missing-xml': 'Missing',
      ...
      'processed.button.load-more': 'Načíst další',
      'processed.button.cancel-order': 'Označit cancelled',
      'processed.button.delete-order': 'Smazat z PrintGuardu',
      ...
      'processed.reprint.field.reason': 'Důvod',
      'processed.reprint.field.requested-by': 'Zadal',
      'processed.reprint.field.requested-at': 'Zadáno',
      'processed.reprint.field.status': 'Stav',
      'processed.reprint.field.confirmed-by': 'Potvrdil',
      'processed.reprint.field.confirmed-at': 'Potvrzeno',
      'processed.reprint.status.waiting': 'Čeká na dotisk',
      'processed.reprint.status.in-production': 'Ve výrobě',
      'processed.reprint.status.done': 'Dotisknuto',
      'processed.reprint.timeline.requested': 'Zadáno',
      'processed.reprint.timeline.xml-processed': 'XML zpracováno',
      'processed.reprint.timeline.completed': 'Dokončeno',
      'processed.reprint.tech.print-file': 'PDF soubor',
      'processed.reprint.tech.workstation': 'Stanice',
      'processed.reprint.tech.xml-file': 'XML soubor',
      'processed.reprint.tech.order-name': 'Název objednávky',
      'processed.reprint.tech.record-status': 'Technický stav',
      'processed.reprint.tech.processed-at': 'Zpracováno',
      'processed.reprint.tech.source-path': 'Zdrojová cesta',
      'processed.reprint.unmatched-records': 'Nepárované technické záznamy',
      'processed.reprint.unmatched-record': 'Zpracovaný reprint',
      'processed.reprint.scope.single-poster': 'Jeden plakát',
      'processed.reprint.scope.full-order': 'Celý order',
      'processed.reprint.scope.generic': 'Reprint',
      'processed.reprint.pdf.full-order': 'celý order',
      'processed.reprint.badge.this-pdf': 'REPRINT PRO TENTO PDF',
      'processed.reprint.badge.included': 'ZAHRNUTO V REPRINTU',
      'processed.reprint.badge.active': 'REPRINT ACTIVE',
      'processed.reprint.badge.full-order': 'REPRINT CELÉHO ORDERU',
      'processed.order-type.single': 'SINGLE ORDER',
      'processed.order-type.combi': 'COMBI ORDER',
      'processed.card.current-status': 'Aktuální stav',
      'processed.card.requested-at': 'Přijato',
      'processed.card.processed-at': 'Zpracováno',
      'processed.card.waiting-production': 'Čeká na výrobu',
      'processed.card.in-production': 'Ve výrobě',
      'processed.card.printed-out': 'Dotisknuto',
      'processed.card.cancelled': 'Cancelled',
      'processed.full-order': 'Celá objednávka',
      'processed.section.processed-reprint-xml': 'Technické reprint záznamy',
      'processed.section.reprint-history': 'Reprint požadavky / historie',
      'processed.section.technical-details': 'Technické detaily',
      'processed.no-reprint-xml': 'Zatím žádná reprint historie.',
      ...
      'daily-report.reload': 'Načíst datum',
      'daily-report.loading': 'Načítám report…',
      'daily-report.copy-text': 'Kopírovat text',
      'daily-report.copy-html': 'Kopírovat HTML',
      'daily-report.open-mail': 'Otevřít e-mail',
      'daily-report.preview.text': 'Text e-mailu',
      'daily-report.preview.html': 'HTML náhled',
      'daily-report.metric.printed': 'Strojové joby',
      'daily-report.metric.processed': 'Submit Tool dnes',
      'daily-report.metric.failed': 'Abrt/deleted',
      'daily-report.metric.received': 'Přijato API',
      'daily-report.metric.waiting': 'Čeká',
      'daily-report.metric.waiting-today': 'SLA bez XML',
      'daily-report.metric.reprint-xml': 'Reprint XML',
      'daily-report.toast.copied': 'Text reportu zkopírován',
      'daily-report.toast.html-copied': 'HTML reportu zkopírován',
      'daily-report.error.load': 'Denní report se nepodařilo načíst',
    ...
    en: {
      ...
      'scan.title': 'Order scan',
      'scan.status.local-ready': 'Local scan queue ready',
      ...
      'scan.status.missing-api': 'Missing PrintGuardScanCaptureApi.',
      'scan.operator': 'Operator',
      'scan.operator.placeholder': 'Name',
      'scan.station': 'Station',
      'scan.pin': 'Submit PIN',
      'scan.barcode.placeholder': 'Scan order barcode…',
      'scan.save': 'Save scan',
      'scan.kpi.pending': 'Pending scans',
      'scan.kpi.pending.desc': 'waiting in browser queue',
      'scan.kpi.last': 'Last barcode',
      'scan.kpi.last.desc': 'last scan in this screen',
      'scan.kpi.local': 'Local queue',
      'scan.kpi.local.desc': 'stored in this browser',
      'scan.kpi.commit': 'Last commit',
      ...
      'scan.queue.empty': 'Local queue is empty.',
      'scan.delete': 'Delete',
      'scan.summary.read': 'Read',
      'scan.summary.committed': 'Committed',
      'scan.summary.matched': 'Matched',
      'scan.summary.unmatched': 'Unmatched',
      'scan.summary.skipped': 'Duplicates / skipped',
      'scan.summary.errors': 'Errors',

      'processed.title': 'Processed Print Orders',
      'processed.status.default': 'Server data',
      'processed.status.loading': 'Loading…',
      'processed.status.searching': 'Searching…',
      'processed.status.rows': 'pipeline orders',
      'processed.status.search-results': 'search results',
      'processed.status.load-failed': 'Load failed',
      'processed.status.pin-required': 'Operator PIN required',
      'processed.status.all': 'All orders',
      'processed.status.needs-attention': 'Needs attention',
      'processed.status.unprocessed': 'Unprocessed',
      'processed.status.processed': 'Processed',
      'processed.status.reprint-pending': 'Waiting for reprint',
      'processed.status.no-api-match': 'No API match',
      'processed.status.has-reprint': 'Has reprint',
      ...
      'processed.quick.reprint-backlog': 'Reprint backlog',
      'processed.quick.no-api-match': 'No API match',
      'processed.quick.printed-out': 'Printed out',
      'processed.summary.unprocessed': 'Unprocessed',
      'processed.summary.reprint-backlog': 'Reprints',
      'processed.summary.needs-attention': 'Needs attention',
      'processed.summary.no-api-match': 'No API match',
      'processed.summary.debug': 'Technical metrics',
      'processed.summary.legacy-technical': 'Legacy / technical',
      'processed.summary.operational': 'Operational summary',
      'processed.summary.scope': 'Filter',
      ...
      'processed.lock': 'Lock',
      'processed.search.placeholder': 'Search',
      ...
      'processed.filters.advanced': 'Advanced filters',
      'processed.filters.period': 'Period',
      'processed.filters.month': 'Import month',
      'processed.filters.from': 'From',
      'processed.filters.to': 'To',
      'processed.filters.reprint-history': 'Reprint history',
      'processed.reprint.all': 'All orders',
      'processed.reprint.has': 'Has reprint request',
      'processed.reprint.pending': 'Waiting for reprint',
      ...
      'processed.badge.reprint-pending': 'REPRINT ACTIVE',
      'processed.badge.reprint-requested': 'REQUEST CREATED',
      'processed.badge.missing-xml': 'Missing',
      ...
      'processed.button.load-details': 'Load PDFs and reprints',
      'processed.button.load-more': 'Load more',
      'processed.button.cancel-order': 'Mark cancelled',
      'processed.button.delete-order': 'Delete from PrintGuard',
      ...
      'processed.reprint.card-title': 'Reprint',
      'processed.reprint.field.reason': 'Reason',
      'processed.reprint.field.requested-by': 'Requested by',
      'processed.reprint.field.requested-at': 'Requested at',
      'processed.reprint.field.status': 'Status',
      'processed.reprint.field.confirmed-by': 'Confirmed by',
      'processed.reprint.field.confirmed-at': 'Confirmed at',
      'processed.reprint.status.waiting': 'Waiting for reprint',
      'processed.reprint.status.in-production': 'In production',
      'processed.reprint.status.done': 'Printed out',
      'processed.reprint.timeline.requested': 'Requested',
      'processed.reprint.timeline.xml-processed': 'XML processed',
      'processed.reprint.timeline.completed': 'Completed',
      'processed.reprint.tech.print-file': 'PDF file',
      'processed.reprint.tech.workstation': 'Workstation',
      'processed.reprint.tech.xml-file': 'XML file',
      'processed.reprint.tech.order-name': 'Order name',
      'processed.reprint.tech.record-status': 'Technical status',
      'processed.reprint.tech.processed-at': 'Processed at',
      'processed.reprint.tech.source-path': 'Source path',
      'processed.reprint.unmatched-records': 'Unmatched technical records',
      'processed.reprint.unmatched-record': 'Processed reprint',
      'processed.reprint.scope.single-poster': 'One poster',
      'processed.reprint.scope.full-order': 'Full order',
      'processed.reprint.scope.generic': 'Reprint',
      'processed.reprint.pdf.full-order': 'full order',
      'processed.reprint.badge.this-pdf': 'REPRINT FOR THIS PDF',
      'processed.reprint.badge.included': 'INCLUDED IN REPRINT',
      'processed.reprint.badge.active': 'REPRINT ACTIVE',
      'processed.reprint.badge.full-order': 'FULL ORDER REPRINT',
      'processed.order-type.single': 'SINGLE ORDER',
      'processed.order-type.combi': 'COMBI ORDER',
      'processed.card.current-status': 'Current status',
      'processed.card.requested-at': 'Received',
      'processed.card.processed-at': 'Processed',
      'processed.card.waiting-production': 'Waiting for production',
      'processed.card.in-production': 'In production',
      'processed.card.printed-out': 'Printed out',
      'processed.card.cancelled': 'Cancelled',
      'processed.full-order': 'Full order',
      'processed.section.processed-reprint-xml': 'Technical reprint records',
      'processed.section.reprint-history': 'Reprint requests / history',
      'processed.section.technical-details': 'Technical details',
      'processed.no-reprint-xml': 'No reprint history yet.',
      'processed.reprint': 'Reprint',
      ...
      'daily-report.reload': 'Load date',
      'daily-report.loading': 'Loading report…',
      'daily-report.copy-text': 'Copy email text',
      'daily-report.copy-html': 'Copy HTML',
      'daily-report.open-mail': 'Open mail client',
      'daily-report.preview.text': 'Email text',
      'daily-report.preview.html': 'HTML preview',
      'daily-report.metric.printed': 'Machine jobs',
      'daily-report.metric.processed': 'Submit Tool today',
      'daily-report.metric.failed': 'Aborted/deleted',
      'daily-report.metric.received': 'API received',
      'daily-report.metric.waiting': 'Waiting',
      'daily-report.metric.waiting-today': 'SLA missing XML',
      'daily-report.metric.reprint-xml': 'Reprint XML',
      'daily-report.toast.copied': 'Report text copied',
      'daily-report.toast.html-copied': 'Report HTML copied',
      'daily-report.error.load': 'Daily report could not be loaded',
