...
assert.strictEqual(
  normalizeOrderIdentityCandidate('ps_26902139'),
  'PS26902139',
);
assert.strictEqual(normalizeOrderIdentityCandidate('26902139'), '26902139');
assert.strictEqual(
  normalizeOrderIdentityCandidate('4770220_REPRINT'),
  '4770220',
);
assert.strictEqual(
  normalizeOrderIdentityCandidate('26902139_retry2'),
  '26902139',
);
assert.strictEqual(
  normalizeOrderIdentityCandidate('C:\\processed\\26902139_REPRINT.xml'),
  null,
);
assert.strictEqual(normalizeOrderIdentityCandidate('26902139.xml'), null);
assert.strictEqual(
  normalizeOrderIdentityCandidate('ONYX_RETRY_2026_05_26'),
  null,
);
