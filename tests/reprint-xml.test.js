...
const source = fs.readFileSync(
  path.join(__dirname, '..', 'scripts', 'reprint-xml.js'),
  'utf8',
);
const context = {
  Blob: class BlobMock {},
...
assert.strictEqual(
  ReprintXml.getReprintOriginalPoNumber({
    orderName: '26967599',
    orderType: 'S',
  }),
  '26967599',
...
assert.strictEqual(
  ReprintXml.getReprintScanBarcode({ orderName: 'PS4775605', orderType: 'S' }),
  'PS4775605RS',
);
assert.strictEqual(
  ReprintXml.getReprintScanBarcode({ orderName: 'PS4775605', orderType: 'C' }),
  'PS4775605RC',
);
assert.strictEqual(
  ReprintXml.getReprintScanBarcode({
    orderName: 'PS4775605RS',
    orderType: 'RS',
  }),
  'PS4775605RS',
);
...
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'S' }),
  /OrderType="RS"/,
);
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'S' }),
...
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'S' }),
  /OriginalPoNumber="26967599"/,
);
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'C' }),
  /OrderType="RC"/,
);
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'C' }),
...
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'R' }),
  /OrderType="R"/,
);
assert.match(
  ReprintXml.generateReprintXml({ orderName: '26967599', orderType: 'R' }),
...
assert.match(
  ReprintXml.generateReprintXml({ orderName: 'PS4775605', orderType: 'S' }),
  /ScanBarcode="PS4775605RS"/,
);
assert.match(
  ReprintXml.generateReprintXml({ orderName: 'PS4775605', orderType: 'C' }),
  /ScanBarcode="PS4775605RC"/,
);
